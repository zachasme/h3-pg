...
Datum h3_get_base_cell(PG_FUNCTION_ARGS)
{
    H3Index *hex = PG_GETARG_H3_INDEX_P(0);
...
Datum h3_is_valid(PG_FUNCTION_ARGS)
{
    H3Index *hex = PG_GETARG_H3_INDEX_P(0);
...
Datum h3_is_res_class_iii(PG_FUNCTION_ARGS)
{
    H3Index *hex = PG_GETARG_H3_INDEX_P(0);
...
Datum h3_is_pentagon(PG_FUNCTION_ARGS)
{
    H3Index *hex = PG_GETARG_H3_INDEX_P(0);
